        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, admin_1.db.collection("interviews").doc(id).get()];
                case 1:
                    interview = _a.sent();
                    return [2 /*return*/, interview.data()];
                case 2:
                    error_2 = _a.sent();
                    console.error("Error getting interview by id:", error_2);
...
function getFeedbackByInterviewId(params) {
    return __awaiter(this, void 0, Promise, function () {
        var interviewId, userId, querySnapshot, feedbackDoc, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    ...
                    if (!interviewId || !userId) {
                        throw new Error("interviewId and userId are required");
                    }
                ...
                case 2:
                    error_3 = _a.sent();
                    console.error("Error getting feedback by interviewId:", error_3);
                    return [2 /*return*/, null];
                case 3: return [2 /*return*/];
            }
        });
...
function getLatestInterviews(params) {
    return __awaiter(this, void 0, Promise, function () {
        var userId, _a, limit, query, interviews, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    query = admin_1.db.collection("interviews")
                        .orderBy("createdAt", "desc")
                        .where("finalized", "==", true);
                    query = query.where("userId", "!=", userId);
                    return [4 /*yield*/, query.limit(limit).get()];
                case 1:
                    interviews = _b.sent();
                    return [2 /*return*/, interviews.docs.map(function (doc) { return (__assign({ id: doc.id }, doc.data())); })];
                case 2:
                    error_4 = _b.sent();
                    console.error("Error getting latest interviews:", error_4);
                    return [2 /*return*/, null];
                case 3: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_5 = _a.sent();
                    console.error("Error getting interviews by userId:", error_5);
                    return [2 /*return*/, null];
                case 3: return [2 /*return*/];
            }
        });
